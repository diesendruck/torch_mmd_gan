...
def get_args(parser):
    ...
    parser.add_argument('--weighted', type=int, default=1, choices=[0, 1])
    parser.add_argument('--lambda_mmd', type=float, default=10., help='scale factor for MMD, exclusively in errG')
    ...
    parser.add_argument('--schedule', type=str, default='original', help='schedule of Diters per Giter', choices=['original', 'constant'])
